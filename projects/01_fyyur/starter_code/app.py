...
def show_artist(artist_id):
  ...
  artist.upcoming_shows=Show.query.filter(Show.artist_id==artist_id).filter(Show.start_time>=current_time)
  artist.upcoming_shows_count=artist.upcoming_shows.count()
  artist.past_shows=Show.query.filter(Show.artist_id==artist_id).filter(Show.start_time<current_time)
